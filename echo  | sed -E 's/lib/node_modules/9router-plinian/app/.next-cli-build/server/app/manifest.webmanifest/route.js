...
`),c.other)for(let a of Object.keys(c.other)){let d=c.other[a];if(null!=d)for(let c of Array.isArray(d)?d:[d])b+=`${a}: ${c}
...
`),e+="</url>\n"}return e+"</urlset>\n"}function i(a){return JSON.stringify(a)}function j(a,b){return"robots"===b?g(a):"sitemap"===b?h(a):"manifest"===b?i(a):""}},96487:()=>{}};var b=require("../../webpack-runtime.js");b.C(a);var c=b.X(0,[4741,1813],()=>b(b.s=47367));module.exports=c})();