...
});`;async function h(a){try{let b=await a.json(),c=b.denoToken?.trim(),h=b.orgDomain?.trim(),i=b.projectName?.trim()||`relay-${Date.now().toString(36)}`;if(!h)return d.NextResponse.json({error:"Organization domain is required"},{status:400});if(!c)return d.NextResponse.json({error:"Deno Deploy API token is required"},{status:400});let j={Authorization:`Bearer ${c}`,"Content-Type":"application/json"},k=await fetch(`${f}/apps`,{method:"POST",headers:j,body:JSON.stringify({slug:i,labels:{"custom.kind":"9router-relay"},config:{install:"deno install",runtime:{type:"dynamic",entrypoint:"main.ts"}}})});if(!k.ok){let a=await k.text().catch(()=>"");if(409===k.status)return d.NextResponse.json({error:`App "${i}" already exists. Choose a different name.`},{status:409});return d.NextResponse.json({error:`Failed to create app (${k.status}): ${a}`},{status:k.status})}let l=await k.json(),m=await fetch(`${f}/apps/${l.id}/deploy`,{method:"POST",headers:j,body:JSON.stringify({assets:{"main.ts":{kind:"file",content:g,encoding:"utf-8"}}})});if(!m.ok){let a=await m.text().catch(()=>"");return console.error("Deno Deploy error:",m.status,a),await fetch(`${f}/apps/${l.id}`,{method:"DELETE",headers:{Authorization:`Bearer ${c}`}}).catch(()=>{}),d.NextResponse.json({error:`Deploy failed (${m.status}): ${a}`},{status:m.status})}let n=await m.json(),o=n.id,p=n.status,q=0;for(;"queued"===p||"building"===p;){if(q>=30)throw Error("Deploy timed out after 60 seconds");await new Promise(a=>setTimeout(a,2e3));let a=await fetch(`${f}/revisions/${o}`,{headers:{Authorization:`Bearer ${c}`}});if(!a.ok)break;p=(await a.json()).status,q++}if("succeeded"!==p)return await fetch(`${f}/apps/${l.id}`,{method:"DELETE",headers:{Authorization:`Bearer ${c}`}}).catch(()=>{}),d.NextResponse.json({error:`Deploy failed with status: ${p}`},{status:500});let r=h.split(".")[0],s=`https://${i}.${r}.deno.net`;console.log("Deno deployUrl:",s);let t=await (0,e.ZO)({name:i,proxyUrl:s,type:"deno",noProxy:"",isActive:!0,strictProxy:!1});return d.NextResponse.json({proxyPool:t,deployUrl:s},{status:201})}catch(a){return console.log("Error deploying Deno Deploy relay:",a),d.NextResponse.json({error:a.message||"Deploy failed"},{status:500})}}},63033:a=>{a.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},71998:(a,b,c)=>{c.d(b,{Fh:()=>d.Fh,L9:()=>d.L9,Mc:()=>d.Mc,OM:()=>d.OM,P:()=>d.getProviderConnections,Pc:()=>d.Pc,Q_:()=>d.Q_,Qu:()=>d.Qu,S8:()=>d.S8,Yd:()=>d.Yd,ZO:()=>d.ZO,c:()=>d.c,createProviderConnection:()=>d.iE,fK:()=>d.fK,fv:()=>d.fv,ho:()=>d.ho,hr:()=>d.hr,i0:()=>d.i0,o5:()=>d.o5,op:()=>d.op,rj:()=>d.updateProviderConnection,uL:()=>d.uL,ui:()=>d.ui,uv:()=>d.uv});var d=c(89718)},73024:a=>{a.exports=require("node:fs")},76760:a=>{a.exports=require("node:path")},77598:a=>{a.exports=require("node:crypto")},79868:a=>{a.exports=require("node:sqlite")},81787:a=>{a.exports=require("bun:sqlite")},86439:a=>{a.exports=require("next/dist/shared/lib/no-fallback-error.external")},87550:a=>{a.exports=require("better-sqlite3")},89718:(a,b,c)=>{c.d(b,{CG:()=>d.CG,Dj:()=>d.Dj,Fh:()=>d.Fh,Iq:()=>d.Iq,K1:()=>d.K1,KJ:()=>d.KJ,L:()=>d.L,L9:()=>d.L9,Lh:()=>d.Lh,Mc:()=>d.Mc,OM:()=>d.OM,PX:()=>d.PX,Pc:()=>d.Pc,Q_:()=>d.Q_,Qu:()=>d.Qu,S8:()=>d.S8,Uv:()=>d.Uv,VT:()=>d.VT,XW:()=>d.XW,Xx:()=>d.Xx,Yd:()=>d.Yd,ZO:()=>d.ZO,bI:()=>d.bI,c:()=>d.c,ek:()=>d.ek,fK:()=>d.fK,fv:()=>d.fv,getProviderConnections:()=>d.P,ho:()=>d.ho,hr:()=>d.hr,i0:()=>d.i0,iE:()=>d.iE,jd:()=>d.jd,mt:()=>d.mt,o5:()=>d.o5,oG:()=>d.oG,op:()=>d.op,r4:()=>d.r4,uL:()=>d.uL,ui:()=>d.ui,updateProviderConnection:()=>d.rj,uv:()=>d.uv,yF:()=>d.yF,yg:()=>d.yg,zP:()=>d.zP});var d=c(9248)},94735:a=>{a.exports=require("events")},94755:(a,b,c)=>{c.d(b,{A:()=>i});var d=c(77598);let e={randomUUID:d.randomUUID},f=new Uint8Array(256),g=f.length;var h=c(50122);let i=function(a,b,c){if(e.randomUUID&&!b&&!a)return e.randomUUID();var i=a,j=c;let k=(i=i||{}).random??i.rng?.()??(g>f.length-16&&((0,d.randomFillSync)(f),g=0),f.slice(g,g+=16));if(k.length<16)throw Error("Random bytes length must be >= 16");if(k[6]=15&k[6]|64,k[8]=63&k[8]|128,b){if((j=j||0)<0||j+16>b.length)throw RangeError(`UUID byte range ${j}:${j+15} is out of buffer bounds`);for(let a=0;a<16;++a)b[j+a]=k[a];return b}return(0,h.k)(k)}}};var b=require("../../../../webpack-runtime.js");b.C(a);var c=b.X(0,[4741,1813,4884],()=>b(b.s=1359));module.exports=c})();