...
// Raised from 60s to 120s so slow reasoning models (e.g. NVIDIA Kimi K3) have time to return headers
// before the upstream prefill / cold start; matches the 200s first-chunk budget.
